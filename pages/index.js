  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section id="hosts" className="max-w-6xl mx-auto px-4 pb-20">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {[
            { name: "Supritha (Host)", bio: "Witty conversation driver. Regional Director turned podcast troublemaker. Jakarta-based.", img: "/hosts/pin2.jpg" },
            { name: "Bindu", bio: "Nature whisperer and keeper of calm, with roots deep in the earth.", img: "/hosts/Bindu.jpg" },
            { name: "Susmitha", bio: "Cat mom and real-life Disney princess, welcoming every animal into her magical garden.", img: "/hosts/Suzie.jpg" },
          ].map((p, i) => (
