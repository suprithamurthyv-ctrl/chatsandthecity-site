  ...
  const episodes = [
    {
      n: 1,
      title: "The First Sip",
      teaser: "Why women’s conversations are the strongest caffeine.",
      img: "/ep-first-sip.jpg",
    },
    {
      n: 2,
      title: "Cat Moms Unite",
      teaser: "On living with fur, claws, and unconditional love.",
      img: "/ep-cat-moms.jpg",
    },
    {
      n: 3,
      title: "Finding Joy in Chaos",
      teaser: "Balancing ambition, self-care, and spontaneity.",
      img: "/ep-joy-in-chaos.jpg",
    },
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/60 bg-white/80 border-b">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a
            href="#subscribe"
            className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 bg-black text-white text-sm font-medium shadow-sm hover:opacity-90"
          >
            Listen now
          </a>
        </div>
        ...
        <div className="grid md:grid-cols-1 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-700 leading-relaxed">
              ...
              to “women’s issues.” We talk about work, love, cats, books, messy
              kitchens, brilliant ideas, and everything in between. No filters,
      ...
      <footer id="contact" className="border-t bg-gray-50">
        ...
        <div className="text-center text-xs text-gray-500 pb-8">
          © {new Date().getFullYear()} Chats & the City
        </div>
      </footer>
    </div>
  );
